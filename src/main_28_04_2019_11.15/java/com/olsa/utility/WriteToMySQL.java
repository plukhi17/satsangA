...
public class WriteToMySQL {
	...
	public Connection executeSelectSQL(String sql) {
		...
		final String DB_LOCAL = "jdbc:mysql://127.0.0.1:3306/istavrity";
		//final String DB_LOCAL = "jdbc:mysql://166.62.46.152:3306/satsanga_istavrity";
		...
		try {
			...
			conn = DriverManager.getConnection(DB_LOCAL,USER,PASS);
