		...
		<div class="row">
			<div class="col-md-8">
				<div class="panel panel-default">
				  ...
				  <form name = "registrationForm" class="form-inline" > <!--  class="form-horizontal"> -->
           
                <div class="col-md-2">
      				<label for="lPhno"> Phone No :</label> <br>
      				  <input type="number" id="phoneNo" name="phoneNo" placeholder="+1(123)456-789"  ng-model="phoneNo" class="form-control" >
      				  <input id="applicationFlow" name="applicationFlow" type="hidden" value = "adminFlow" >
      		</div>
      		
           <div class="col-md-2">
      		<label for="pwd">SA Family Code :</label> <br>
